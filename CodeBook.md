Subject: identifier of each test subject
Activity: category of activity with values :
WALKING 
WALKING_UPSTAIRS
WALKING_DOWNSTAIRS
SITTING
STANDING
LAYING
The rest of variables represent the average of mean or desviation standar value grouped by each activity and by each test subject:
